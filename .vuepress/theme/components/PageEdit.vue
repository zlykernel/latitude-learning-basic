  ...
  <footer class="page-edit">
    ...
    <div class="git-hub-star" v-if="showGitStar">
      <span class="prefix" v-if="pageWords > 0">
        Kudos to
        <github-button
          href="https://github.com/zlykernel/latitude-learning-basic"
    ...
    <div v-if="lastUpdated" class="last-updated" v-if="showGitStar">
      ...
      <span class="words" v-if="pageWords > 0">{{
        pageWords.toLocaleString()
      }}</span>
...
export default {
  ...
  computed: {
    ...
    showGitStar() {
      return (
        !this.$frontmatter.githubStar && this.$frontmatter.githubStar !== false
      );
    },
